export default class ExpertInsight {
    ...
    constructor(obj = null) {
        ...
        this.organization_name =  obj?.organization_name ? obj?.organization_name : "No organization Name"
        ...
        this.madarek_special =  obj?.madarek_special ? obj?.madarek_special : "No madarek Special"
        ...
        this.categoryInfo =  obj?.category_info ? obj?.category_info : "No information"
